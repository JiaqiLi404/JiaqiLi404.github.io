...
excerpt: 'A Gaussian mixture model with built-in DTW for clustering variable-length time-series.'
date: 2023-11-01
...
This paper proposes a Gaussian mixture model with built-in DTW to better cluster length-varying time-series data.
